...
public interface UsersMapper {
    ...
    @Select("select count(*) from users where phone = #{phone} and password = #{password} and isenable = 0")
    int checkUser(@Param("phone") String phone,@Param("password") String password);
